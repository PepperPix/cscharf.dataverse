...
namespace CScharf.Dataverse.Tests.Fixtures;

[DataContract]
[EntityLogicalName("testentity")]
public class TestEntity : Entity, INotifyPropertyChanging, INotifyPropertyChanged
{
    [DebuggerNonUserCode]
    ...
    {
        [DebuggerNonUserCode] get { return base.Id; }
        [DebuggerNonUserCode] set { TestEntityId = value; }
    }

    [AttributeLogicalName("testentityid")]
    public Guid? TestEntityId
    {
        [DebuggerNonUserCode] get { return GetAttributeValue<Guid?>("testentityid"); }
        [DebuggerNonUserCode]
        set
        {
    ...
    {
        [DebuggerNonUserCode] get { return GetAttributeValue<EntityReference>("createdby"); }
    }

    [AttributeLogicalName("createdon")]
    public DateTime? CreatedOn
    {
        [DebuggerNonUserCode] get { return GetAttributeValue<DateTime?>("createdon"); }
    }

    [AttributeLogicalName("modifiedby")]
    public EntityReference ModifiedBy
    {
        [DebuggerNonUserCode] get { return GetAttributeValue<EntityReference>("modifiedby"); }
    }

    [AttributeLogicalName("modifiedon")]
    public DateTime? ModifiedOn
    {
        [DebuggerNonUserCode] get { return GetAttributeValue<DateTime?>("modifiedon"); }
    }

    [AttributeLogicalName("overriddencreatedon")]
    public DateTime? OverriddenCreatedOn
    {
        [DebuggerNonUserCode] get { return GetAttributeValue<DateTime?>("overriddencreatedon"); }
        [DebuggerNonUserCode]
        set
        {
    ...
    public string Name
    {
        [DebuggerNonUserCode] get { return GetAttributeValue<string>("name"); }
        [DebuggerNonUserCode]
        set
        {
    ...
    {
        [DebuggerNonUserCode] get { return GetAttributeValue<string>("webpage"); }
        [DebuggerNonUserCode]
        set
        {
    ...
    public string Email
    {
        [DebuggerNonUserCode] get { return GetAttributeValue<string>("email"); }
        [DebuggerNonUserCode]
        set
        {
    ...
    public string Phone
    {
        [DebuggerNonUserCode] get { return GetAttributeValue<string>("phone"); }
        [DebuggerNonUserCode]
        set
        {
    ...
    {
        [DebuggerNonUserCode] get { return GetAttributeValue<string>("description"); }
        [DebuggerNonUserCode]
        set
        {
    ...
    {
        [DebuggerNonUserCode] get { return GetAttributeValue<OptionSetValue>("statecode"); }
    }
